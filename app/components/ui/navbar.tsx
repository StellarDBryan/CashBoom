    ...
    return(
        ...
        : <>
            <nav className="fixed top-0 flex flex-row flex-nowrap gap-3 lg:gap-5 items-center justify-between z-50 bg-gray-50 text-neutral-600 w-full h-[70px] md:h-[75px] md:px-5 overflow-hidden">
                ...
                {session 
                    ? 
                        <div className="z-50 h-[70px] md:h-full -ml-1 sm:-ml-0 mr-0 sm:mr-2 md:mr-0 fixed flex flex-row flex-nowrap bottom-0 md:static bg-gray-50 md:bg-transparent w-screen md:w-auto">
        ...
        <>
            <div className="flex flex-row flex-nowrap gap-0 -space-x-2 sm:-space-x-0 lg:gap-5 h-full w-[80%] md:w-auto items-center object-contain">
                <NavLinkBtn isSelected={pathname === '/home'} redirectTo="/home"> 
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className="-mt-1 w-[35px] h-[35px] sm:w-[25px] sm:h-[25px] lg:w-[30px] lg:h-[30px]">
                ...
                <NavLinkBtn isSelected={pathname === '/challenges'} redirectTo="/challenges">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 512 512" className="w-[35px] h-[35px] sm:w-[25px] sm:h-[25px] lg:w-[30px] lg:h-[30px]">
                ...
                <NavLinkBtn isSelected={pathname === '/store'} redirectTo="/store">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className="w-[35px] h-[35px] sm:w-[25px] sm:h-[25px] lg:w-[30px] lg:h-[30px]">
                ...
                <NavLinkBtn isSelected={pathname === '/blog'} redirectTo="/blog">
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 14 14" className="w-[27px] h-[27px] sm:w-[21px] sm:h-[21px] lg:w-[26px] lg:h-[26px]">
