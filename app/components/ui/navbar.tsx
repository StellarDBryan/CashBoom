    ...
    return(
        <>
            <div className="flex flex-row flex-nowrap gap-5 h-full items-center ">
                ...
                <Link href="/challenges" className="h-full">
...
function UserAvatar({ session }: { session: Session }){
    return(
        <Dropdown shouldBlockScroll={false}>
            <DropdownTrigger>
                <Button variant="light" className="flex flex-row flex-nowrap items-center justify-center lg:gap-3 h-full px-4">
                    <div className="flex flex-row flex-nowrap items-center gap-2">
                        <span className="text-end text-wrap truncate text-regular font-medium text-neutral-800">{session.user!.name}</span>
                    ...
                    <Avatar showFallback 
                        ...
                        isBordered
                        className="flex-shrink-0 w-[55px] h-[55px] ring-[2px] ring-offset-2 ring-green-600" />
                </Button>
            </DropdownTrigger>
            <DropdownMenu>
